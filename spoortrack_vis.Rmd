...
for(i in unique(dat$burstID))
{
  dat[dat$burstID==i,]$timestamp2<-lubridate::ymd_hms(
    paste(dat[dat$burstID==i,]$timestamp,rep(rev(c("00","01","02","03", "04", "05", "06", "07", "08", "09", 10:59)), 5), sep=":"), tz="UTC")
}

# at present data is arranged as recieved in descending time order
