...
dat$DateTime<-ymd_hms(dat$time_UTC, tz="UTC")
dat$DateTime_AEDT<-with_tz(dat$DateTime, "Australia/Sydney")
...
# add dist colony. Actually use track2kba to get masic metrics and split trips
